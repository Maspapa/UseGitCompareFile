GcResize コンポーネントは、ActiveReports for .NET（以下、ActiveReports）のリサイズ操作を最適化するテンプレートの ActiveReportsResizePolicy を提供しています。
テンプレートの適用方法については、「[リサイズポリシーの使い方](gcdocsite__documentlink?toc-item-id=7324ead3-01ce-4f49-a573-f9161960138b)」を参照してください。

## ビューワ

ビューワが ActiveReports のコンテンツコントロールである場合、リサイズ操作を行っても、そのコンテンツ領域は拡大されませんが、ActiveReportsResizePolicy を使用すればビューワ内のコンテンツ領域も拡大されます。

> !type=warning
> ビューワのツールバー上のボタンやテキストボックスなどは拡大できません。

| 既定のサイズ | リサイズ時（リサイズポリシーなし） | リサイズ時（リサイズポリシーあり） |
| ------ | ----------------- | ----------------- |
| ![](/DOCUMENT_SITE_LINK_PREFIX_HERE/document-site-files/images/06fadbb1-c461-433a-b385-ae4966e56069/images/gcresize.activereports.png) | ![](/DOCUMENT_SITE_LINK_PREFIX_HERE/document-site-files/images/06fadbb1-c461-433a-b385-ae4966e56069/images/gcresize.activereportsnoresizepolicy.png) | ![](/DOCUMENT_SITE_LINK_PREFIX_HERE/document-site-files/images/06fadbb1-c461-433a-b385-ae4966e56069/images/gcresize.activereportsresizepolicy.png) |
