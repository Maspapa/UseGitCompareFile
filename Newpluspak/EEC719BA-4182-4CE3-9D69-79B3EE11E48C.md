[GcRadioGroupBox](gcdocsite__documentlink?toc-item-id=022ae48e-d4ac-4751-a9f5-2102adec7179)コントロールは、複数の RadioButton コントロールをひとつのグループボックス内で管理するコントロールで、グループボックス全体の有効・無効、折りたたみと展開を容易に実装できます。また、ラジオボタンの並び方やレイアウトを細かくカスタマイズすることが可能です。
...
![](/DOCUMENT_SITE_LINK_PREFIX_HERE/document-site-files/images/06fadbb1-c461-433a-b385-ae4966e56069/images/gcradiogroupbox.png)
ここでは、GcRadioGroupBoxコントロールの利用方法について、以下の項目に分けて解説しています。
