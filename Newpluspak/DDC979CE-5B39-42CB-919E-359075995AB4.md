GcResize コンポーネントは、 CalendarGrid に搭載されているコントロールのリサイズ操作を最適化する組み込みのリサイズポリシーを提供しています。
テンプレートの適用方法については、「[リサイズポリシーの使い方](gcdocsite__documentlink?toc-item-id=7324ead3-01ce-4f49-a573-f9161960138b)」を参照してください。

## GcCalendarGridのリサイズポリシー

GcCalendarGridResizePolicy は、GcCalendarGrid コントロールのリサイズ操作をサポートします。GcCalendarGridResizePolicy により、リサイズ時のフォントが最適化されます。

| 既定のサイズ | リサイズ時（リサイズポリシーなし） | リサイズ時（リサイズポリシーあり） |
| ------ | ----------------- | ----------------- |
| ![](/DOCUMENT_SITE_LINK_PREFIX_HERE/document-site-files/images/06fadbb1-c461-433a-b385-ae4966e56069/images/gcresize.calendargrid.png) | ![](/DOCUMENT_SITE_LINK_PREFIX_HERE/document-site-files/images/06fadbb1-c461-433a-b385-ae4966e56069/images/gcresize.calendargrid.noresizepolicy.png) | ![](/DOCUMENT_SITE_LINK_PREFIX_HERE/document-site-files/images/06fadbb1-c461-433a-b385-ae4966e56069/images/gcresize.calendargrid.resizepolicy.png) |
