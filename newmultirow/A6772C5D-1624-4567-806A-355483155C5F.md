GcMultiRowコントロールのセルを水平方向にリサイズした場合、セルのリサイズが行われる前に[GcMultiRow.CellResizeCompleting](gcdocsite__documentlink?toc-item-id=dcb47ebf-fd5a-46bf-833b-80818dc78548)イベントが発生します。このイベントでリサイズのオフセット処理を行うことができます。
