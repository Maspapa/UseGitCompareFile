デザイナは、3種類の表示モードを提供します。表示モードは画面下部のタブで切り替えることができます。
![デザイナのタブ](/DOCUMENT_SITE_LINK_PREFIX_HERE/document-site-files/images/f148c511-6e98-4b55-9904-150a375d5825/images/userguide/designer_tabs.png)

## 設計時モード

設計時モードでは、テンプレートやセルの設定を変更できます。

## 実行時モード

実行時モードでは、設計したテンプレートをGcMultiRowコントロールに読み込んだときの動作を確認できます。GcMultiRow コントロールのプロパティは、既定の設定が使用されます。
このモードでセルに入力した値はドキュメント ウィンドウを閉じるまで保持されます。

## 印刷プレビュー モード

印刷プレビュー モードでは、設計したテンプレートをGcMultiRowコントロールに読み込んで印刷するときの結果を確認できます。GcMultiRowコントロールのプロパティは、既定の設定が使用されます。
印刷のプロパティはツールバーから設定できます。
![印刷プレビュー モードのツールバー](/DOCUMENT_SITE_LINK_PREFIX_HERE/document-site-files/images/f148c511-6e98-4b55-9904-150a375d5825/images/userguide/designer_viewmode_printing_toolbar.png)
![印刷設定ダイアログ](/DOCUMENT_SITE_LINK_PREFIX_HERE/document-site-files/images/f148c511-6e98-4b55-9904-150a375d5825/images/userguide/designer_viewmode_printing_settings.png)
