デザイナを使用すると、グリッドコントロールの雛形となるテンプレートを簡単に作成できます。ここでは、デザイナの基本的な用法について説明します。高度な機能を使用して、より効率よくテンプレートを設計する方法は「[デザイナの高度な使い方](gcdocsite__documentlink?toc-item-id=85cf4890-1848-43f8-bdad-5f605c6aec9a)」を参照してください。
